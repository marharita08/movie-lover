...
} from "../validation/new-password-step.validation-schema";

export const NewPasswordStep = () => {
  const form = useForm<NewPasswordStepValidationSchemaType>({
    resolver: zodResolver(NewPasswordStepValidationSchema),
    defaultValues: {
